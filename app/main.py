...
from app.api.routes import auth, convos
from app.api.routes.convos import convos_router
...
app.include_router(convos_router, prefix="/contacts", tags=["contacts"], dependencies=[Depends(verify_and_decode_access_token)])
